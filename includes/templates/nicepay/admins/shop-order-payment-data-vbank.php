...
?>
    ...
    <div id="shpg-payment-data">
        ...
        <?php if ( $account_number ) : ?>
            <p>
                <strong><?php esc_html_e( 'Account Number', 'shoplic-pg' ); ?></strong>
                <span><?php echo esc_html( $account_number ); ?></span>
            </p>
        <?php endif; ?>

        <?php if ( $expiration ) : ?>
            <p>
                <strong><?php esc_html_e( 'Expiration', 'shoplic-pg' ); ?></strong>
        ...
        <?php if ( $notification_result ) : ?>
            <p>
                <strong><?php echo esc_html_x( 'Notification', 'Virtaul bank account deposit notification.', 'shoplic-pg' ); ?></strong>
                <span><?php echo esc_html( $notification_result ); ?></span>
            </p>
        <?php endif; ?>
