...
if ( ! class_exists( 'SHPG_Register_Base_Option' ) ) {
	abstract class SHPG_Register_Base_Option implements SHPG_Register {
		use SHPG_Hook_Impl;
		...
		public function __get( string $alias ): ?SHPG_Reg_Option {
			if ( isset( $this->fields[ $alias ] ) ) {
				return SHPG_Reg_Option::factory( $this->fields[ $alias ] );
			}
