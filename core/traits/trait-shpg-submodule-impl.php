...
if ( ! trait_exists( 'SHPG_Submodule_Impl' ) ) {
	trait SHPG_Submodule_Impl {
		/**
		 * Submodules
		 *
		 * @var array
		...
		protected function assign_modules( array $modules, bool $auto_wrap = false ): self {
			$cps = shpg()->get_constructor_params();
